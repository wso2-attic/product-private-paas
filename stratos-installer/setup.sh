...
function sm_setup() {
    ...
    sed -i "s@CONFIG_DB_HOSTNAME@$registry_db_hostname@g" repository/conf/datasources/master-datasources.xml
    sed -i "s@CONFIG_DB_PORT@$registry_db_port@g" repository/conf/datasources/master-datasources.xml
    sed -i "s@CONFIG_DB_SCHEMA@$registry_db_schema@g" repository/conf/datasources/master-datasources.xml
    sed -i "s@CONFIG_DB_USER@$registry_db_user@g" repository/conf/datasources/master-datasources.xml
    sed -i "s@CONFIG_DB_PASS@$registry_db_pass@g" repository/conf/datasources/master-datasources.xml
