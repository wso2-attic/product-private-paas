...
function fetchData(callback) {
    ...
    if (cluster != "" && member == 'All Members') {
        ...
        jQuery("#placeholder").append('<div id="noChart"><table><tr><td style="padding:30px 20px 0px 20px"><img src="../../portal/images/noEvents.png" align="left" style="width:24;height:24"/></td><td><br/><b><p><br/>Cluster instance details can be viewed at cluster level. Please select All Members to view cluster instance details for a cluster.</p></b></td></tr></table></div>');
    }
}
