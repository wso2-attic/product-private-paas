...
public class ServiceUtils {
            ...
            if (cartridgeInfo.getMultiTenant()) {
                ...
                try {
                    ...
                    if (service != null) {
                        ...
                        String errorMsg =
                                "Multi tenant Service already exists for " + cartridgeType + ", cannot undeploy";
                        log.error(errorMsg);
                        throw new RestAPIException(errorMsg);
                    } else {
                        // can undeploy
    ...
    public static StratosAdminResponse updateAutoscalingPolicy(AutoscalePolicy autoscalePolicyBean)
            throws RestAPIException {
        ...
        try {
            ...
            String msg = String.format(
                    "Error while updating autoscale policy %s . Error while connecting to Cloud Conroller Service",
                    autoscalePolicy.getId());
            log.error(msg, e);
            throw new RestAPIException(msg, e);
        }
        catch (AutoScalerServiceInvalidPolicyExceptionException e) {
            String msg = String.format("Error while updating autoscale policy %s . Autoscale policy is not valid",
                    autoscalePolicy.getId());
            log.error(msg, e);
            throw new RestAPIException(msg, e);
        }
        ...
        StratosAdminResponse stratosAdminResponse = new StratosAdminResponse();
        stratosAdminResponse.setMessage(
                "Successfully updated autoscaling policy definition with id " + autoscalePolicyBean.getId());
        return stratosAdminResponse;
    }
    ...
    public static StratosAdminResponse deployDeploymentPolicy(
        ...
        StratosAdminResponse stratosAdminResponse = new StratosAdminResponse();
        stratosAdminResponse
                .setMessage("Successfully deployed deployment policy definition with type " + deploymentPolicyBean.id);
        return stratosAdminResponse;
    }
    ...
    getPartitionsOfGroup(String deploymentPolicyId, String groupId) throws RestAPIException {
        ...
        if (autoscalerServiceClient != null) {
            try {
                ...
                String errorMsg =
                        "Error while getting available partitions for deployment policy id " + deploymentPolicyId +
    ...
    public static StratosAdminResponse undeployAutoScalePolicy(String autoscalePolicyName) throws RestAPIException {
        ...
        try {
            ...
            String msg = String.format(
                    "Error while undeploying autoscale policy %s . Error while connecting to Cloud Conroller Service",
                    autoscalePolicyName);
            log.error(msg, e);
            throw new RestAPIException(msg, e);
        }
            ...
            for (String availableCartridge : availableCartridges) {
                ...
                try {
                    ...
                    org.apache.stratos.messaging.domain.topology.Service service =
                            TopologyManager.getTopology().getService(availableCartridge);
                    ...
                    for (Cluster cluster : clusters) {
                        if (cluster != null && cluster.getAutoscalePolicyName() != null) {
                            if (cluster.getAutoscalePolicyName().equals(autoscalePolicyName)) {
                                String msg = String.format(
                                        "Cannot remove autoscale policy %s. Because it is used in the service %s ",
                                        autoscalePolicyName, cluster.getServiceName());
                                log.error(msg);
        ...
        try {
            ...
            String msg = String.format("Error while undeploying autoscale policy %s . Autoscale policy %s not found",
    ...
    static Cartridge getAvailableCartridgeInfo(String cartridgeType, Boolean multiTenant,
    ...
    private static boolean isAlreadySubscribed(String cartridgeType,
        ...
        Collection<CartridgeSubscription> subscriptionList =
                cartridgeSubsciptionManager.isCartridgeSubscribed(tenantId, cartridgeType);
    ...
    public static ServiceDefinitionBean getDeployedServiceInformation(String type) throws RestAPIException {
        ...
        try {
            ...
            String msg =
                    "Unable to get deployed service information for [type]: " + type + ". Cause: " + e.getMessage();
            log.error(msg, e);
            throw new RestAPIException(msg, e);
        }
    ...
    public static List<Cartridge> getActiveDeployedServiceInformation(ConfigurationContext configurationContext)
            throws RestAPIException {
    ...
    static Cartridge getSubscription(String cartridgeAlias, ConfigurationContext configurationContext)
        ...
        Cartridge cartridge = getCartridgeFromSubscription(
                cartridgeSubsciptionManager.getCartridgeSubscription(ApplicationManagementUtil.
    ...
    public static org.apache.stratos.rest.endpoint.bean.topology.Cluster getCluster(String cartridgeType,
        ...
        if (cluster == null) {
            throw new RestAPIException(
                    "No matching cluster found for [cartridge type]: " + cartridgeType + " [alias] " +
                            subscriptionAlias);
        } else {
    ...
    public static org.apache.stratos.rest.endpoint.bean.topology.Cluster[] getClustersForTenant(
            ConfigurationContext configurationContext) {
    ...
    public static org.apache.stratos.rest.endpoint.bean.topology.Cluster[] getClustersForTenantAndCartridgeType(
            ConfigurationContext configurationContext,
    ...
    public static org.apache.stratos.rest.endpoint.bean.topology.Cluster[] getClustersForCartridgeType(
            String cartridgeType) {
     ...
     */
    static StratosAdminResponse deployService(String cartridgeType, String alias, String autoscalingPolicy,
                                              String deploymentPolicy,
                                              String tenantDomain, String tenantUsername, int tenantId,
                                              String clusterDomain, String clusterSubdomain, String tenantRange)
            throws RestAPIException {
        log.info("Deploying service..");
        try {
            serviceDeploymentManager.deployService(cartridgeType, autoscalingPolicy, deploymentPolicy, tenantId,
                    tenantRange, tenantDomain, tenantUsername);

        }
        catch (Exception e) {
            String msg = String.format("Failed to deploy the Service [Cartridge type] %s [alias] %s . Cause: %s",
                    cartridgeType, alias, e.getMessage());
            log.error(msg, e);
            throw new RestAPIException(msg, e);
        }
    ...
    static StratosAdminResponse undeployService(String serviceType) throws RestAPIException {
        ...
        try {
            ...
            String msg = "Failed to undeploy service cluster definition of type " + serviceType + " Cause: " +
                    e.getMessage();
            log.error(msg, e);
            throw new RestAPIException(msg, e);
        }
        ...
        StratosAdminResponse stratosAdminResponse = new StratosAdminResponse();
        stratosAdminResponse
                .setMessage("Successfully undeployed service cluster definition for service type " + serviceType);
        return stratosAdminResponse;
    }
    ...
    static StratosAdminResponse synchronizeRepository(CartridgeSubscription cartridgeSubscription)
            throws RestAPIException {
        try {
            RepositoryNotification repoNotification = new RepositoryNotification();
        ...
        StratosAdminResponse stratosAdminResponse = new StratosAdminResponse();
        stratosAdminResponse.setMessage(
                "Successfully sent the repository synchronization request for " + cartridgeSubscription.getAlias());
        return stratosAdminResponse;
    }
