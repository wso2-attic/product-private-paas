...
public class StratosAdmin extends AbstractAdmin {
    ...
    @AuthorizationAction("/permission/protected/manage/monitor/tenants")
    @SuperTenantService(true)
    public StratosAdminResponse unDeployCartridgeDefinition(@PathParam("cartridgeType") String cartridgeType)
            throws RestAPIException {
    ...
    @AuthorizationAction("/permission/protected/manage/monitor/tenants")
    @SuperTenantService(true)
    public StratosAdminResponse undeployAutoscalingPolicyDefintion(
            @PathParam("autoscalePolicyName") String autoscalePolicyName) throws RestAPIException {
    ...
    @Consumes("application/json")
    @AuthorizationAction("/permission/protected/manage/monitor/tenants")
    public Cartridge[] getSubscribedCartridgesForServiceGroup(@PathParam("serviceGroup") String serviceGroup)
            throws RestAPIException {
    ...
    public SubscriptionInfo[] bulkSubscribe(CartridgeInfoBeanWrapper subscriptionWrapper) throws RestAPIException {
        ...
        return ServiceUtils.bulkSubscribe(subscriptionWrapper.getCartridgeInfoBeans());
    }
    ...
    public StratosAdminResponse addTenant(TenantInfoBean tenantInfoBean) throws RestAPIException {
        ...
        stratosAdminResponse
                .setMessage("Successfully added new tenant with domain " + tenantInfoBean.getTenantDomain());
        return stratosAdminResponse;
    }
    ...
    @AuthorizationAction("/permission/protected/manage/monitor/tenants")
    @SuperTenantService(true)
    public StratosAdminResponse deactivateTenant(@PathParam("tenantDomain") String tenantDomain)
            throws RestAPIException {
    ...
    public StratosAdminResponse deployService(ServiceDefinitionBean serviceDefinitionBean)
        ...
        return ServiceUtils.deployService(serviceDefinitionBean.getCartridgeType(), UUID.randomUUID().toString(),
                serviceDefinitionBean.getAutoscalingPolicyName(),
    ...
    public Response getLoadBalancerCluster(@PathParam("cartridgeType") String cartridgeType,
            ...
            throws RestAPIException {
        if (log.isDebugEnabled()) {
            log.debug(String.format("GET /cartridge/%s/subscription/%s/load-balancer-cluster", cartridgeType,
                    subscriptionAlias));
        }
