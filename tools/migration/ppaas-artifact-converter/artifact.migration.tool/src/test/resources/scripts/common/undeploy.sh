...
curl -X DELETE -H "Content-Type: application/json" -k -v -u ${var_username}:${var_password} ${var_base_url}api/cartridges/cartridge_name
...
curl -X DELETE -H "Content-Type: application/json" -k -v -u ${var_username}:${var_password} ${var_base_url}api/applicationPolicies/application-policy-1
