...
package org.wso2.ppaas.rest.endpoint.bean.util.type.map;
...
public class MapAdapter<S, T> extends XmlAdapter<MapType, Map<S, T>> {
    ...
    @Override public MapType marshal(Map<S, T> v) throws Exception {
    ...
    @Override public Map<S, T> unmarshal(MapType v) throws Exception {
