...
package org.wso2.ppaas.rest.endpoint.bean.util.converter;
...
import org.wso2.ppaas.rest.endpoint.bean.topology.Member;
import org.wso2.ppaas.rest.endpoint.bean.cartridge.definition.*;
...
public class PojoConverter {
    ...
    private static IaasConfig[] getIaasConfigsAsArray(List<IaasProviderBean> iaasProviderBeans) {
        ...
        for (int i = 0; i < iaasProviderBeansArray.length; i++) {
            ...
            if (iaasProviderBeansArray[i].networkInterfaces != null && !iaasProviderBeansArray[i].networkInterfaces
                    .isEmpty()) {
                iaasConfig.setNetworkInterfaces(
                        PojoConverter.getNetworkInterfaces(iaasProviderBeansArray[i].networkInterfaces));
            }
    ...
    public static org.apache.stratos.cloud.controller.stub.deployment.partition.Partition convertToCCPartitionPojo(
        ...
        org.apache.stratos.cloud.controller.stub.deployment.partition.Partition partition = new org.apache.stratos.cloud.controller.stub.deployment.partition.Partition();
    ...
    public static org.apache.stratos.autoscaler.deployment.policy.DeploymentPolicy convetToCCDeploymentPolicyPojo(
            DeploymentPolicy deploymentPolicyBean) {

        org.apache.stratos.autoscaler.deployment.policy.DeploymentPolicy deploymentPolicy = new org.apache.stratos.autoscaler.deployment.policy.DeploymentPolicy();
    ...
    private static org.apache.stratos.autoscaler.partition.PartitionGroup[] convertToCCPartitionGroup(
            List<PartitionGroup> partitionGroupBeans) {

        org.apache.stratos.autoscaler.partition.PartitionGroup[] partitionGroups = new org.apache.stratos.autoscaler.partition.PartitionGroup[partitionGroupBeans
                .size()];

        for (int i = 0; i < partitionGroupBeans.size(); i++) {
            org.apache.stratos.autoscaler.partition.PartitionGroup partitionGroup = new org.apache.stratos.autoscaler.partition.PartitionGroup();
    ...
    public static org.wso2.ppaas.rest.endpoint.bean.topology.Cluster populateClusterPojos(Cluster cluster) {
        org.wso2.ppaas.rest.endpoint.bean.topology.Cluster cluster1 = new org.wso2.ppaas.rest.endpoint.bean.topology.Cluster();
    ...
    private static org.apache.stratos.cloud.controller.stub.deployment.partition.Partition[] convertToCCPartitionPojos(
        ...
        org.apache.stratos.cloud.controller.stub.deployment.partition.Partition[] partitions = new org.apache.stratos.cloud.controller.stub.deployment.partition.Partition[partitionList
                .size()];
    ...
    public static List<SubscriptionDomainBean> populateSubscriptionDomainPojos(
            List<SubscriptionDomain> subscriptionDomains) {
    ...
    public static DeploymentPolicy[] populateDeploymentPolicyPojos(
    ...
    public static DeploymentPolicy populateDeploymentPolicyPojo(
        ...
        if (deploymentPolicy.getPartitionGroups() != null && deploymentPolicy.getPartitionGroups().length > 0) {
            deploymentPolicyBean.partitionGroup = Arrays
                    .asList(populatePartitionGroupPojos(deploymentPolicy.getPartitionGroups()));
        }
    ...
    public static PartitionGroup populatePartitionGroupPojo(
            org.apache.stratos.autoscaler.partition.PartitionGroup partitionGroup) {
    ...
    private static List<Partition> getPartitionList(
            org.apache.stratos.cloud.controller.stub.deployment.partition.Partition[] partitions) {
