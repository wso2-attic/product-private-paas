...
public class Constants {
    ...
    //Constants for PPaaS 4.0.0 REST API endpoints
    ...
    //Constants for default values for the application policy
    ...
    //Constants for default value for network partition
    public static final String NETWORK_PARTITION_ID = "partition-1";
    //Constants for default value for application names
    public static final String APPLICATION_NAME = "-application";
    //Constants for default file names for application policy jsons and domain mapping jsons
    ...
    //Constants for default values for cartridges
    ...
    //IaaS provider configuration strings
    public static final String IAAS = "iaas";
    public static final String IAAS_IMAGE_ID = "iaasImageId";
    public static final String NETWORK_UUID = "networkUuID";
    //Network partition curl commands
    public static final String NETWORK_PARTITION_DEPLOYMENT_CURL_COMMAND_PART1 = "curl -X POST -H \"Content-Type: application/json\" -d \"@${network_partitions_path}/";
    public static final String NETWORK_PARTITION_DEPLOYMENT_CURL_COMMAND_PART2 = ".json\" -k -v -u ${var_username}:${var_password} ${var_base_url}api/networkPartitions";
    public static final String NETWORK_PARTITION_UNDEPLOYMENT_CURL_COMMAND = "curl -X DELETE -H \"Content-Type: application/json\" -k -v -u ${var_username}:${var_password} ${var_base_url}api/networkPartitions/";
    ...
    public static final String URL_MULTI_TENANT_CARTRIDGE =
            MIGRATION_API_PATH + "cartridge" + File.separator + "tenanted" + File.separator + "list";
