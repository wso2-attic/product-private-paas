...
public class Constants {
    ...
    public static String ROOT_TEMPLATE_DIRECTORY = System.getProperty("user.dir") + "/../template/";
    ...
    public static final String DIRECTORY_TEMPLATE_POLICY_AUTOSCALE = "autoscaling-policies"+ File.separator+"autoscaling-policy-1.json";
    public static final String DIRECTORY_TEMPLATE_NETWORK_PARTITION = "network-partitions"+ File.separator+"gce"+ File.separator+"network-partition-1.json";
    public static final String DIRECTORY_TEMPLATE_POLICY_DEPLOYMENT = "deployment-policies"+ File.separator+"deployment-policy-1.json";
    public static final String DIRECTORY_TEMPLATE_CARTRIDGE = "cartridges"+ File.separator+"ec2"+ File.separator+"c1.json";
    public static final String DIRECTORY_TEMPLATE_APPLICATION = "applications"+ File.separator+"simple"+ File.separator+"single-cartridge-app"+ File.separator+"artifacts"+ File.separator+"application.json";
