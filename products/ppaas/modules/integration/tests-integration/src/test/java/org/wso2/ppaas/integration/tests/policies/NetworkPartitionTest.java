...
public class NetworkPartitionTest extends PPaaSIntegrationTest {
    ...
    public NetworkPartitionTest() throws Exception {
    }

    @Test(description = "Deploy network partition", timeOut = APPLICATION_TEST_TIMEOUT)
    ...
    @Test(description = "Deploy network partition 2", timeOut = APPLICATION_TEST_TIMEOUT)
