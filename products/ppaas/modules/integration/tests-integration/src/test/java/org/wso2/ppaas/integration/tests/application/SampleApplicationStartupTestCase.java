...
import org.wso2.ppaas.integration.common.TopologyHandler;
...
public class SampleApplicationStartupTestCase extends PPaaSIntegrationTest {
    ...
    public SampleApplicationStartupTestCase() throws Exception {
    }

    @Test(description = "Application startup, activation and faulty member detection",
          timeOut = APPLICATION_TEST_TIMEOUT)
