 ...
 */
public class SampleApplicationsTest extends PPaaSIntegrationTest {
    ...
    public SampleApplicationsTest() throws Exception {
    }

    @Test(description = "Deploy sample application", priority = 1, timeOut = APPLICATION_TEST_TIMEOUT)
    public void testApplication() throws Exception {
        ...
        assertEquals(removedN2, true, "[Network partition] network-partition-sample-applications-test-2 " +
                "could not be removed for [application] g-sc-G123-1-sample-applications-test");
