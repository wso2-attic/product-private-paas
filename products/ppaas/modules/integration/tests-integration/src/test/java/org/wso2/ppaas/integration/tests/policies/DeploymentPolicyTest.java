 ...
 */
public class DeploymentPolicyTest extends PPaaSIntegrationTest {
    ...
    public DeploymentPolicyTest() throws Exception {
    }

    @Test(description = "Deploy deployment policy", timeOut = APPLICATION_TEST_TIMEOUT)
    ...
    @Test(description = "Deploy deployment policy 2", timeOut = APPLICATION_TEST_TIMEOUT)
