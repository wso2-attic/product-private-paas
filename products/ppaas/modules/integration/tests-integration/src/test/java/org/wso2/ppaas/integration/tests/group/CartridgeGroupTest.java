 ...
 */
public class CartridgeGroupTest extends PPaaSIntegrationTest {
    ...
    public CartridgeGroupTest() throws Exception {
    }

    @Test(description = "Deploy cartridge group", timeOut = APPLICATION_TEST_TIMEOUT)
    ...
    @Test(description = "Deploy cartridge group 2", timeOut = APPLICATION_TEST_TIMEOUT)
