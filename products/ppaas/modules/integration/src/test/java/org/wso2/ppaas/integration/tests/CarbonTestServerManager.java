...
public class CarbonTestServerManager extends TestServerManager {
    ...
    protected void copyArtifacts(String carbonHome) throws IOException {
        ...
        copyConfigFile(carbonHome, commonResourcesPath, CLOUD_CONTROLLER_FILENAME, CARBON_CONF_PATH);
        copyConfigFile(carbonHome, commonResourcesPath, AUTOSCALER_FILENAME, CARBON_CONF_PATH);
        copyConfigFile(carbonHome, commonResourcesPath, CARTRIDGE_CONFIG_PROPERTIES_FILENAME, CARBON_CONF_PATH);
        copyConfigFile(carbonHome, commonResourcesPath, IDENTITY_FILENAME, CARBON_CONF_PATH);
        copyConfigFile(carbonHome, commonResourcesPath, SCALING_DROOL_FILENAME, CARBON_CONF_PATH + PATH_SEP + "drools");
