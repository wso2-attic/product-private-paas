...
class BranchBasedArtifactCheckout(IArtifactCheckoutPlugin):
    """
    ...
    def checkout(self, repo_info):
        ...
        branch_name = "tenant_" + str(repo_info.tenant_id)
        new_git_repo = AgentGitHandler.create_git_repo(repo_info, branch_name)
        ...
        git_repo = AgentGitHandler.create_git_repo(repo_info, branch_name)
