...
function update(source) {
    ...
    nodeEnter.append("image")
        ...
        function (d) {
            if (d.type == 'clusters') {
                return "../../themes/privatePaaS/images/topology/cluster.png";
            } else if (d.type == 'groups') {
                return "../../themes/privatePaaS/images/topology/group.png";
            } else if (d.type == 'members') {
                return "../../themes/privatePaaS/images/topology/member.png";
            } else {
                return "../../themes/privatePaaS/images/topology/application.png";
            }
        })
        .attr("class", "created")
        .attr("x", -16)
