...
public class IaasMetadataResponseHandler implements ResponseHandler<IaasMetadataResponse>{
    ...
    public IaasMetadataResponse handleResponse(HttpResponse response) throws ClientProtocolException,
            IOException {
        ...
        IaasMetadataResponse kubResponse = new IaasMetadataResponse();
